...
useEffect( () => {
  ...
  <div className="App">
    <Section>
      <Container>
        <Heading >
          <a className="Title" href="/" >Discoverify</a>
        </Heading>
      </Container>
    </Section>
    <Section>
    ...
    <Section>
      <Container>
        <Content className="Footer">
          <p>
          Discoverify by <a href="http://bahbi.net">Bahbi</a>. The source code is licensed <a href="http://opensource.org/licenses/mit-license.php"> MIT</a>. <a href="https://github.com/superbahbi/Discoverify">Github</a> 
          </p>
        </Content>
      </Container>
    </Section>
